...
import {isCategoriesValid, isNameValid, isExpiredDate} from './validators';
...
const ProductForm = (props) => {
    ...
    const EXPIRATION_MAX_DAYS = 30;

    const onSubmit = (e) => {
        e.preventDefault();
        onSetFeature(product.featured);
        props.onSave({
            name,
            brand,
            rating,
    ...
    const onSetFeature = (value) => {
        // value > MAX_FEATURED ? setFeatured(true) : setFeatured(false);
        setFeatured(value > MAX_FEATURED);
    }
    ...
    return (
        <Form onSubmit={onSubmit}>
            ...
            <FormGroup>
                ...
                <Input
                    invalid={!isExpiredDate(expirationDate, EXPIRATION_MAX_DAYS)}
                    type="date"
                    name="expirationDate"
                    id="expirationDate"
